      ...
      <section className="py-20 bg-secondary/30 grid-pattern">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 gradient-text">{t("gallery")}</h1>
          </div>
        </div>
      </section>
                  ...
                  {researchImages.map((image, index) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-muted-foreground text-sm mt-1">{image.location}</p>
                        <p className="mt-3 text-sm">{image.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
